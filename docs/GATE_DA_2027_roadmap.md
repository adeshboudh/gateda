...
- Never finish a C block without writing 3 lines: _what / when used / common trap_.
...
- **A topic that scores < 50% in 3 consecutive sectionals**: declare it a _weak topic_; allocate the next 4 R sessions to it before resuming rotation.
