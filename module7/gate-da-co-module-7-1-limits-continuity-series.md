...
**Where this sits:** Calculus & Optimization $\rightarrow$ *Limits, Continuity & Series*. Module **1 of 3** in Subject 7 — the final subject.
...
### Example 1 — Limit at infinity *(2025 Q32 · NAT)*
...
**Answer: $0.5$.** *Method:* rationalize, then divide by the dominant power.

---

### Example 2 — A $0/0$ limit via Taylor *(2024 Q60 · NAT)*
...
**Answer: $0.5$.** *Method:* split the log, then Taylor-expand each piece.

---

### Example 3 — Double geometric series *(2026 Q35 · NAT)*
...
**Answer: $1$.** *Trap avoided:* mind the **start index** — the $i$-sum starts at $0$, the $j$-sum at $1$.

---

### Example 4 — Continuity of a piecewise function *(original · Easy–Med)*
...
All equal $2$, so $f$ is **continuous at $x=1$**. *Method:* left $=$ right $=$ value. *(Module 7.2 adds the differentiability check — see 2024 Q37.)*
...
**Q2. ★ (NAT)** $\displaystyle\lim_{x\to2}\frac{x^2-4}{x-2}=$ __________ .

**Q3. ★★ (NAT)** $\displaystyle\lim_{x\to0}\frac{1-\cos x}{x^2}=$ __________ .
...
**Q8. ★★ (NAT)** $\displaystyle\lim_{x\to0}\frac{e^{2x}-1}{x}=$ __________ .

**Q9. ★★★ (NAT)** $\displaystyle\lim_{x\to0}\frac{\sin 3x}{\sin 5x}=$ __________ .

**Q10. ★★ (NAT)** $\displaystyle\sum_{n=1}^{\infty}\Big(\frac23\Big)^n=$ __________ .
